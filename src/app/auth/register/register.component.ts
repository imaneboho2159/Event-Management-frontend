        ...
        <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="space-y-6">
          ...
          <div class="flex items-start">
            <mat-checkbox formControlName="acceptTerms" 
                        class="custom-checkbox text-sm text-gray-600">
              I agree to the 
              <a class="text-[#6C63FF] hover:text-[#B06AB3] transition-colors cursor-pointer ml-1">
...
export class RegisterComponent {
  ...
  onSubmit(): void {
    if (this.registerForm.valid) {
      this.isLoading = true;
      const { acceptTerms, ...registrationData } = this.registerForm.value;
